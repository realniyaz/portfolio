...
export default function CallToAction() {
  return (
    <section className="relative py-24 md:py-40 px-6 md:px-12 lg:px-24 overflow-hidden bg-transparent">
      ...
      {/* 1. Ultra-Thin Guide Lines (Hidden on small mobile to reduce clutter) */}
      ...
      >
        {/* Subtle Label */}
        <motion.div variants={itemVariants} className="flex justify-center items-center gap-3 mb-6 md:mb-8">
        ...
        {/* Subtext: Better line height and width for mobile reading */}
        <motion.p 
          variants={itemVariants}
        ...
        >
          Bridging the gap between <span className="text-white">scalable backends</span> and <span className="text-white">fluid frontends</span>. 
